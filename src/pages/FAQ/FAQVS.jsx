  ...
  return (
    <><section className="bg-white text-black" >
          <div className="container flex flex-col justify-center p-4 mx-auto md:p-8">
              ...
              <h2 className="mb-12 text-5xl font-bold leading-none text-center grid  place-items-center sm:text-5xl ">Fragen zum vServer</h2>
            ...
            <div className=' pt-20 w-full sm:hidden  flex justify-between text-gray-font  bottom-0   '>
             ...
             <div className=' w-full  hidden md:inline  flex justify-between text-gray-font  bottom-0 absolute inset-x-0 bottom-0 h-0   '>
              <Footer />
             </div></>
  )
}

export default FAQVS